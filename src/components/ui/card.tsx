  ...
  return (
    <div
      ...
      className={cn(
        ...
        "before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-br before:from-primary/[0.003] before:to-transparent before:opacity-0 before:pointer-events-none before:-z-10",
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "leading-tight font-semibold text-lg tracking-tight",
        className
      )}
      {...props}
    />
